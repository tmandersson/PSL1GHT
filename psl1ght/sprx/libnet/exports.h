...
EXPORT(accept_sprx,						0xc94f6939);
EXPORT(bind_sprx,						0xb0a59804);
EXPORT(connect_sprx,					0x64f66d35);
EXPORT(gethostbyaddr,					0xf7ac8941);
EXPORT(gethostbyname,					0x71f4c717);
EXPORT(getpeername_sprx,				0xf9ec2db6);
EXPORT(getsockname_sprx,				0x13efe7f5);
EXPORT(getsockopt_sprx,					0x5a045bd1);
...
EXPORT(listen_sprx,						0x28e208bb);
EXPORT(recv_sprx,						0xfba04f37);
EXPORT(recvfrom_sprx,					0x1f953b9f);
EXPORT(recvmsg_sprx,					0xc9d09c34);
EXPORT(send_sprx,						0xdc751b40);
EXPORT(sendmsg_sprx,					0xad09481b);
EXPORT(sendto_sprx,						0x9647570b);
EXPORT(setsockopt_sprx,					0x88f03575);
EXPORT(shutdown_sprx,					0xa50777c6);
EXPORT(socket_sprx,						0x9c056962);
EXPORT(closesocket_sprx,				0x6db6e8cd);
EXPORT(socketpoll_sprx,					0x051ee3ee);
EXPORT(socketselect_sprx,				0x3f09e20a);
