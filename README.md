...
-------
    ...
    geohot      - make_self_npdrm (geohot in no way authorized the usage of his tools in PSL1GHT, and as far as we know he does not even know we have used them. The tools are public domain so we did not require permission to use them.)
